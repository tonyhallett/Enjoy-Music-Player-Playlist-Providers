...
Object.defineProperty(exports, "__esModule", { value: true });
var METADATA_KEY = __webpack_require__(0);
var ERROR_MSGS = __webpack_require__(2);
...
Object.defineProperty(exports, "__esModule", { value: true });
let Types = {
    IPlaylistManager: Symbol("IPlaylistManager"),
    IUIManager: Symbol("IUIManager"),
    UIUnexpectedErrorMessage: Symbol("UIUnexpectedErrorMessage"),
    IUIInjector: Symbol("IUIInjector"),
    UIInjectorInterval: Symbol("UIInjectorInterval"),
    UIInjectorTimeoutDetails: Symbol("UIInjectorTimeoutDetails"),
    IPlaylistElementFinder: Symbol("IPlaylistElementFinder"),
    PlaylistElementSelector: Symbol("PlaylistElementSelector"),
    IPlaylistElementCreator: Symbol("IPlaylistElementCreator"),
    IPlaylistElementInjector: Symbol("IPlaylistElementInjector"),
    IPlaylistProvider: Symbol("IPlaylistProvider"),
    IMessageService: Symbol("IMessageService"),
    IPlaylistStore: Symbol("IPlaylistStore"),
    MessageOptions: Symbol("MessageOptions"),
    MessageIcons: Symbol("MessageIcons"),
    IWPLParser: Symbol("IWPLParser"),
    IIOAsyncHelper: Symbol("IIOAsyncHelper"),
    IMediaGalleryManager: Symbol("IMediaGalleryManager"),
    musicFileExtensions: Symbol("musicFileExtensions"),
};
exports.Types = Types;
...
Object.defineProperty(exports, "__esModule", { value: true });
var binding_when_syntax_1 = __webpack_require__(9);
...
var container_module_1 = __webpack_require__(27);
exports.ContainerModule = container_module_1.ContainerModule;
var injectable_1 = __webpack_require__(17);
exports.injectable = injectable_1.injectable;
var tagged_1 = __webpack_require__(21);
exports.tagged = tagged_1.tagged;
var named_1 = __webpack_require__(19);
exports.named = named_1.named;
var inject_1 = __webpack_require__(16);
exports.inject = inject_1.inject;
var optional_1 = __webpack_require__(20);
exports.optional = optional_1.optional;
var unmanaged_1 = __webpack_require__(23);
exports.unmanaged = unmanaged_1.unmanaged;
var multi_inject_1 = __webpack_require__(18);
exports.multiInject = multi_inject_1.multiInject;
var target_name_1 = __webpack_require__(22);
exports.targetName = target_name_1.targetName;
var metadata_reader_1 = __webpack_require__(11);
exports.MetadataReader = metadata_reader_1.MetadataReader;
var guid_1 = __webpack_require__(5);
exports.guid = guid_1.guid;
var decorator_utils_1 = __webpack_require__(3);
...
Object.defineProperty(exports, "__esModule", { value: true });
const inversify_1 = __webpack_require__(10);
...
myContainer.bind(types_1.Types.IPlaylistManager).to(entities_1.PlaylistManager).inSingletonScope();
myContainer.bind(types_1.Types.IUIManager).to(entities_1.UIManager).inSingletonScope();
myContainer.bind(types_1.Types.UIUnexpectedErrorMessage).toConstantValue("Error preparing the ui");
myContainer.bind(types_1.Types.IUIInjector).to(entities_1.UIInjector).inSingletonScope();
myContainer.bind(types_1.Types.UIInjectorInterval).toConstantValue(100);
myContainer.bind(types_1.Types.UIInjectorTimeoutDetails).toConstantValue({ timeout: 2000, timoutMessageTitle: "Load timeout", timeoutMessageBody: "Expected DOM not loaded within timeout interval" });
myContainer.bind(types_1.Types.IPlaylistElementFinder).to(entities_1.PlaylistElementFinder);
myContainer.bind(types_1.Types.PlaylistElementSelector).toConstantValue('#app > div.s1.main > div > div.side-bar.flex.vert > ul.nav-list.s1> li');
myContainer.bind(types_1.Types.IPlaylistElementCreator).to(entities_1.PlaylistElementCreator);
myContainer.bind(types_1.Types.IPlaylistElementInjector).to(entities_1.PlaylistElementInjector);
myContainer.bind(types_1.Types.IPlaylistProvider).to(entities_1.WPLPlaylistProvider).inSingletonScope();
myContainer.bind(types_1.Types.IPlaylistProvider).to(entities_1.FolderPlaylistProvider).inSingletonScope();
myContainer.bind(types_1.Types.IIOAsyncHelper).to(entities_1.IOAsyncHelper).inSingletonScope();
myContainer.bind(types_1.Types.IWPLParser).to(entities_1.WPLParser).inSingletonScope();
myContainer.bind(types_1.Types.IMediaGalleryManager).to(entities_1.MediaGalleryManager).inSingletonScope();
myContainer.bind(types_1.Types.IMessageService).to(entities_1.MessageService).inSingletonScope();
myContainer.bind(types_1.Types.IPlaylistStore).to(entities_1.IndexedDbStore).inSingletonScope();
myContainer.bind(types_1.Types.MessageOptions).toConstantValue({ timeout: 3000 });
myContainer.bind(types_1.Types.MessageIcons).toConstantValue({ errorPath: "img/symbol_error.png", successPath: "img/symbol_check.png" });
myContainer.bind(types_1.Types.musicFileExtensions).toConstantValue(["mp3", "wav", "aiff", "mp4", "m4a", "aif", "wma", "flac", "m4a"]);
...
Object.defineProperty(exports, "__esModule", { value: true });
var METADATA_KEY = __webpack_require__(0);
var ERRORS_MSGS = __webpack_require__(2);
function injectable() {
...
Object.defineProperty(exports, "__esModule", { value: true });
var guid_1 = __webpack_require__(5);
var literal_types_1 = __webpack_require__(4);
...
Object.defineProperty(exports, "__esModule", { value: true });
var binding_1 = __webpack_require__(24);
var lookup_1 = __webpack_require__(29);
var planner_1 = __webpack_require__(32);
var resolver_1 = __webpack_require__(37);
var binding_to_syntax_1 = __webpack_require__(40);
var serialization_1 = __webpack_require__(6);
var container_snapshot_1 = __webpack_require__(28);
var guid_1 = __webpack_require__(5);
var ERROR_MSGS = __webpack_require__(2);
var METADATA_KEY = __webpack_require__(0);
var literal_types_1 = __webpack_require__(4);
...
Object.defineProperty(exports, "__esModule", { value: true });
var plan_1 = __webpack_require__(31);
var context_1 = __webpack_require__(30);
var request_1 = __webpack_require__(35);
var target_1 = __webpack_require__(12);
var binding_count_1 = __webpack_require__(25);
...
Object.defineProperty(exports, "__esModule", { value: true });
var binding_in_syntax_1 = __webpack_require__(38);
var binding_when_syntax_1 = __webpack_require__(9);
var binding_on_syntax_1 = __webpack_require__(8);
...
Object.defineProperty(exports, "__esModule", { value: true });
var binding_in_when_on_syntax_1 = __webpack_require__(39);
var binding_when_on_syntax_1 = __webpack_require__(13);
var literal_types_1 = __webpack_require__(4);
var ERROR_MSGS = __webpack_require__(2);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(41), __webpack_require__(45)))
...
const inversify_1 = __webpack_require__(10);
const types_1 = __webpack_require__(7);
let IndexedDbStore = class IndexedDbStore {
    openAsync(dbName) {
    ...
    transactionAsync(database, storeNames, mode, transactionInitFunc) {
        return new Promise((resolve, reject) => {
    ...
    savePlaylist(playlist) {
        return __awaiter(this, void 0, void 0, function* () {
            var database = yield this.openAsync("EMP");
            yield this.transactionAsync(database, "playlists", "readwrite", (transaction) => {
...
IndexedDbStore = __decorate([
    inversify_1.injectable()
], IndexedDbStore);
exports.IndexedDbStore = IndexedDbStore;
let MessageService = class MessageService {
    constructor(messageOptions, messageIcons) {
    ...
    show(success, titleText, bodyText) {
        var iconUrl = success ? this.successImgUrl : this.errorImgUrl;
        var selfClosingNotification = new Notification(titleText, { body: bodyText, icon: iconUrl });
        return new Promise((resolve, reject) => {
            setTimeout(() => {
...
MessageService = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(types_1.Types.MessageOptions)), __param(1, inversify_1.inject(types_1.Types.MessageIcons)),
    __metadata("design:paramtypes", [Object, Object])
], MessageService);
exports.MessageService = MessageService;
let IOAsyncHelper = class IOAsyncHelper {
    readDirectoryFilesAsync(directoryEntry) {
        return __awaiter(this, void 0, void 0, function* () {
            var entries = yield this.readDirectoryAsync(directoryEntry);
            return entries.filter(e => e.isFile);
        });
    }
    readDirectoryAsync(directoryEntry) {
        var directoryReader = directoryEntry.createReader();
        return this.directoryReaderReadEntriesAsync(directoryReader);
    }
    directoryReaderReadEntriesAsync(directoryReader) {
        return new Promise((resolve, reject) => {
    ...
    chooseEntryAsync(options) {
        return new Promise((resolve, reject) => {
            chrome.fileSystem.chooseEntry(options, (entryOrEntries) => {
                return resolve(entryOrEntries);
            });
        });
    }
    fileEntryFileAsync(fileEntry) {
        return new Promise((resolve, reject) => {
            fileEntry.file((file) => {
                resolve(file);
            }, (fileError) => {
    ...
    fileReaderReadAsTextAsync(file) {
        return new Promise((resolve, reject) => {
    ...
    fileEntryTextAsync(fileEntry) {
        return this.fileEntryFileAsync(fileEntry).then(file => this.fileReaderReadAsTextAsync(file));
    }
};
IOAsyncHelper = __decorate([
    inversify_1.injectable()
], IOAsyncHelper);
exports.IOAsyncHelper = IOAsyncHelper;
let MediaGalleryManager = class MediaGalleryManager {
    /* addUserSelectedFolderAsync(): Promise<UserSelectedFolderDetails> {
        return new Promise<UserSelectedFolderDetails>((resolve, reject) => {
            chrome.mediaGalleries.addUserSelectedFolder((mediaFileSystems, selectedFileSystemName) => {
                resolve( { mediaFileSystems: mediaFileSystems, selectedFileSystemName: selectedFileSystemName });
            })
        });
    } */
    addUserSelectedFolderAsync() {
        return new Promise((resolve, reject) => {
            chrome.mediaGalleries.addUserSelectedFolder((mediaFileSystems, selectedFileSystemName) => {
                var selectedMfs = null;
...
MediaGalleryManager = __decorate([
    inversify_1.injectable()
], MediaGalleryManager);
exports.MediaGalleryManager = MediaGalleryManager;
let WPLParser = class WPLParser {
    parsePlaylist(playlistString) {
        var parser = new DOMParser();
        var dom = parser.parseFromString(playlistString, "text/xml");
        ...
        var seq = [];
        var wplPlaylist = { title: title, seq: seq };
...
WPLParser = __decorate([
    inversify_1.injectable()
], WPLParser);
exports.WPLParser = WPLParser;
let WPLPlaylistProvider = class WPLPlaylistProvider {
    constructor(ioAsyncHelper, wplParser, galleryManager) {
        this.ioAsyncHelper = ioAsyncHelper;
        this.wplParser = wplParser;
        this.galleryManager = galleryManager;
        this.description = "New playlist from WPL";
    }
    getWplPlaylist() {
        return __awaiter(this, void 0, void 0, function* () {
            var wplFileEntry = yield this.ioAsyncHelper.chooseEntryAsync({ type: 'openFile', acceptsAllTypes: false, accepts: [{ extensions: ['wpl'] }] });
            if (wplFileEntry) {
                var wplText = yield this.ioAsyncHelper.fileEntryTextAsync(wplFileEntry);
    ...
    newPlaylist() {
        return __awaiter(this, void 0, void 0, function* () {
            var playlist = null;
            var wplPlaylist = yield this.getWplPlaylist();
            if (wplPlaylist) {
                var galleryDetails = yield this.galleryManager.getGalleriesAsync();
                var playlistSongs = [];
...
WPLPlaylistProvider = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(types_1.Types.IIOAsyncHelper)), __param(1, inversify_1.inject(types_1.Types.IWPLParser)), __param(2, inversify_1.inject(types_1.Types.IMediaGalleryManager)),
    __metadata("design:paramtypes", [Object, Object, Object])
], WPLPlaylistProvider);
exports.WPLPlaylistProvider = WPLPlaylistProvider;
let FolderPlaylistProvider = class FolderPlaylistProvider {
    constructor(ioAsyncHelper, galleryManager, musicFileExtensions) {
        this.ioAsyncHelper = ioAsyncHelper;
        this.galleryManager = galleryManager;
        this.musicFileExtensions = musicFileExtensions;
        this.description = "New playlist from folder";
    }
    getPlaylistNameAndGalleryId(fileSystem) {
    ...
    getMetadataFileNames(musicFileEntries) {
        return __awaiter(this, void 0, void 0, function* () {
            var getMetadataPromises = musicFileEntries.map(fe => {
                return this.ioAsyncHelper.fileEntryFileAsync(fe).then((f) => __awaiter(this, void 0, void 0, function* () {
                    var metadata = yield this.galleryManager.getMetadataAsync(f);
    ...
    getMusicFileEntries(directory) {
        return __awaiter(this, void 0, void 0, function* () {
            var fileEntries = yield this.ioAsyncHelper.readDirectoryFilesAsync(directory);
    ...
    newPlaylist() {
        return __awaiter(this, void 0, void 0, function* () {
            var playlist = null;
            var fileSystem = yield this.galleryManager.addUserSelectedFolderAsync();
            if (fileSystem) {
                var playlistNameAndId = this.getPlaylistNameAndGalleryId(fileSystem);
                var directory = fileSystem.root;
                var musicFileEntries = yield this.getMusicFileEntries(directory);
                var musicMetadataNames = yield this.getMetadataFileNames(musicFileEntries);
...
FolderPlaylistProvider = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(types_1.Types.IIOAsyncHelper)), __param(1, inversify_1.inject(types_1.Types.IMediaGalleryManager)), __param(2, inversify_1.inject(types_1.Types.musicFileExtensions)),
    __metadata("design:paramtypes", [IOAsyncHelper, Object, Array])
], FolderPlaylistProvider);
exports.FolderPlaylistProvider = FolderPlaylistProvider;
let PlaylistElementFinder = class PlaylistElementFinder {
...
PlaylistElementFinder = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(types_1.Types.PlaylistElementSelector)),
    __metadata("design:paramtypes", [String])
], PlaylistElementFinder);
exports.PlaylistElementFinder = PlaylistElementFinder;
let PlaylistElementCreator = class PlaylistElementCreator {
    create(playlistElement, uiNewPlaylists) {
        return uiNewPlaylists.map(ppd => {
            var newPlaylistLi = playlistElement.cloneNode(true);
            newPlaylistLi.onclick = ppd.newPlaylist;
            newPlaylistLi.title = ppd.description;
            newPlaylistLi.children[1].innerText = ppd.description;
            return newPlaylistLi;
        });
    }
};
PlaylistElementCreator = __decorate([
    inversify_1.injectable()
], PlaylistElementCreator);
exports.PlaylistElementCreator = PlaylistElementCreator;
let PlaylistElementInjector = class PlaylistElementInjector {
    inject(playlistElement, newPlaylistElements) {
...
PlaylistElementInjector = __decorate([
    inversify_1.injectable()
], PlaylistElementInjector);
exports.PlaylistElementInjector = PlaylistElementInjector;
let UIInjector = class UIInjector {
    constructor(playlistElementFinder, playlistElementCreator, playlistElementInjector) {
        this.playlistElementFinder = playlistElementFinder;
        this.playlistElementCreator = playlistElementCreator;
        this.playlistElementInjector = playlistElementInjector;
    }
    domReady() {
        this.playlistElement = this.playlistElementFinder.find();
        return !!this.playlistElement;
    }
    inject(playlistProviderDetails) {
...
UIInjector = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(types_1.Types.IPlaylistElementFinder)), __param(1, inversify_1.inject(types_1.Types.IPlaylistElementCreator)), __param(2, inversify_1.inject(types_1.Types.IPlaylistElementInjector)),
    __metadata("design:paramtypes", [Object, Object, Object])
], UIInjector);
exports.UIInjector = UIInjector;
let UIManager = class UIManager {
    constructor(uiInjector, messageService, interval, timeoutDetails, unexpectedErrorMessage) {
    ...
    addNewPlaylistProviders(playlistProviderDetails) {
        ...
        return new Promise((resolve, reject) => {
            var interval = setInterval(() => {
                try {
                    ...
                    this.messageService.show(false, this.unexpectedErrorMessage, body);
                    clearInterval(interval);
...
UIManager = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(types_1.Types.IUIInjector)), __param(1, inversify_1.inject(types_1.Types.IMessageService)), __param(2, inversify_1.inject(types_1.Types.UIInjectorInterval)), __param(3, inversify_1.inject(types_1.Types.UIInjectorTimeoutDetails)), __param(4, inversify_1.inject(types_1.Types.UIUnexpectedErrorMessage)),
    __metadata("design:paramtypes", [Object, Object, Number, Object, String])
], UIManager);
exports.UIManager = UIManager;
let PlaylistManager = PlaylistManager_1 = class PlaylistManager {
    constructor(uiManager, playlistProviders, playlistStore, messageService) {
        this.uiManager = uiManager;
        this.playlistProviders = playlistProviders;
        this.playlistStore = playlistStore;
        this.messageService = messageService;
    }
    addNewPlaylistCallback(playlistProvider) {
        return playlistProvider.newPlaylist().then((playlist) => {
            if (playlist) {
                return this.playlistStore.savePlaylist(playlist).then(() => {
                    this.messageService.show(true, PlaylistManager_1.playlistCreatedTitle, playlist.name);
                });
            }
        }).catch((err) => {
            this.messageService.show(false, PlaylistManager_1.playlistErrorTitle, err ? err : "");
        });
    }
    setUp() {
...
PlaylistManager.playlistCreatedTitle = "Created playlist !";
PlaylistManager.playlistErrorTitle = "There has been an error";
PlaylistManager = PlaylistManager_1 = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(types_1.Types.IUIManager)), __param(1, inversify_1.multiInject(types_1.Types.IPlaylistProvider)), __param(2, inversify_1.inject(types_1.Types.IPlaylistStore)), __param(3, inversify_1.inject(types_1.Types.IMessageService)),
    __metadata("design:paramtypes", [Object, Array, Object, Object])
], PlaylistManager);
exports.PlaylistManager = PlaylistManager;
var PlaylistManager_1;
...
Object.defineProperty(exports, "__esModule", { value: true });
const inversify_config_1 = __webpack_require__(15);
const types_1 = __webpack_require__(7);
var playlistManager = inversify_config_1.myContainer.get(types_1.Types.IPlaylistManager);
